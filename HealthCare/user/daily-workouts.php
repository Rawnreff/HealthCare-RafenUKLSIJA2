    ...
    <div class="mentoring">
      <div class="card-mentoring">
        ...
        <div class="card-mentoring-text">
          ...
          <hr>
          <ol>
            <li>Start in a plank position. Your core should be tight, shoulders pulled down and back, and your neck
              neutral.</li>
      ...
      <div class="card-mentoring">
        ...
        <div class="card-mentoring-text">
          ...
          <hr>
          <ol>
            <li>Pick a light set of dumbbells — we recommend 10 pounds to start — and start by standing, either with
    ...
    <div class="mentoring">
        ...
        <div class="card-mentoring-text">
          ...
          <ol>
            ...
            <li>Repeat 10 to 12 reps before moving the weight to your left hand and repeating the same steps on the left
              leg. It's suggested to do 3 sets of 10-12 reps per side.</li>
          </ol>
        </div>
      </div>
      ...
      <div class="card-mentoring">
        ...
        <div class="card-mentoring-text">
          ...
          <hr>
          <ol>
            <li>Lie on your right side with your left leg and foot stacked on top of your right leg and foot. Prop your
      ...
      <div class="card-mentoring">
        ...
        <div class="card-mentoring-text">
          ...
          <hr>
          <ol>
            <li>Begin in a pushup position with your hand and toes firmly planted on the ground, your back straight, and
              your core tight.</li>
      ...
      <div class="card-mentoring">
        ...
        <div class="card-mentoring-text">
          ...
          <hr>
          <ol>
            <li>Start by lying on the floor with your knees bent, feet flat on the ground, and arms straight at your
