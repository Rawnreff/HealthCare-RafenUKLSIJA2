...
<body>
    <div class="regist-container">
        ...
        <form class="form" action="adminarticleadd.php" method="POST" enctype="multipart/form-data">
            ...
            <textarea style="height:40px; width:392px; margin-top: 10px; margin-bottom: 8px;" name="information" required></textarea>

            <label for="content">Content:</label>
            <textarea style="height:200px; width:392px; margin-top: 10px; margin-bottom: 8px;" name="content" required></textarea>
        ...
        if ($_FILES["image"]["error"] == 4) {
            ...
            if (!in_array($imageExtension, $validImageExtension)) {
                ...
                if ($user_query && mysqli_num_rows($user_query) > 0) {
                    ...
                    $query_get_personalization = "SELECT p.id_personalization, p.preferences 
                    ...
                    if ($result_get_personalization && mysqli_num_rows($result_get_personalization) > 0) {
                        ...
                        $preferences_type = $row_get_personalization['preferences'];
                    } else {
                        echo "<script> alert('Maximum articles amount reached'); </script>";
                        exit();
                    }

                    $query_insert = "INSERT INTO article(id_personalization, image, title, information, content, preferences_type)
                                    VALUES('$id_personalization', '$newImageName', '$title', '$information', '$content', '$preferences_type')";
